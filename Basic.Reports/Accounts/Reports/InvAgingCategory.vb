...
Public Class InvAgingCategory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic.Reports.InvAgingCategory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvAgingCategory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvAgingCategory = New InvAgingCategory()
        rpt.Site = Me.Site
        Return rpt
    End Function
