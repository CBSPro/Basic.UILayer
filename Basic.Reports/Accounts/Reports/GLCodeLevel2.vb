...
Public Class GLCodeLevel2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic.Reports.GLCodeLevel2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGLCodeLevel2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GLCodeLevel2 = New GLCodeLevel2()
        rpt.Site = Me.Site
        Return rpt
    End Function
