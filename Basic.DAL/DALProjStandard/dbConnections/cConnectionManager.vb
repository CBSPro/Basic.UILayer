...
Public Class cConnectionManager
    ...
    Public Shared Function GetConnection() As Object
        ...
        Try
            ...
            DatabaseServer = Constants.ProjConst.SysServer
            'DatabaseServer = "CBS-Server"
            Database = Constants.ProjConst.SysDataBase
            DatabaseUser = Constants.ProjConst.SysUser
            DatabasePassword = Constants.ProjConst.SysPassword
        ...
        End Try
    End Function
    Public Shared Function GetConnection(ByVal SysServer As String, ByVal SysDataBase As String, ByVal SysUser As String, ByVal SysPassword As String) As Object
        'Dim DBType As String
        'Dim mode As String
        Try
            objSqlConn = New SqlConnection
