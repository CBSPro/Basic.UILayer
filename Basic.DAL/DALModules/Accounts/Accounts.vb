...
Public Module Accounts
    ...
    Public Function fChkCode(ByVal mCode As String) As Boolean
        ...
        mSQL = "SELECT FaCODE,FaName FROM FaCodes " & _
                    ...
                    "FaCODE = '" & mCode & "'"
        If Not Found(mSQL) Then
            MsgBox("This Fixed Asset Does Not Exist, No Transactions are Allowed", vbCritical, Constants.ProjConst.SysCompany)
            fChkCode = False
            Exit Function
        End If
        fChkCode = True
    ...
    Public Function ChkCode(ByVal mCode As String) As Boolean
        ...
        If (mCode <> "") Then
            ...
            mSQL = "SELECT CODE,Description FROM Codes " & _
                        ...
                        "CODE = '" & mCode & "'"
            If Not Found(mSQL) Then
                MsgBox("This Account Does Not Exist, No Transactions are Allowed", vbCritical, Constants.ProjConst.SysCompany)
                ChkCode = False
                Exit Function
            End If
            ChkCode = True
        ...
        If PrtNotes Then
            ...
            mSQL = "SELECT MAX(Codes.DESCRIPTION) AS Description, SUBSTRING(Gledg.CODE,1," & CodeLen & ") AS Code, " & _
             ...
             "From Gledg, Codes, " & _
                   ...
                   "'" & Format(Constants.ProjConst.SDate, "dd-MMM-yyyy") & "' And " & _
        ...
        If PrtNotes Then
            ...
            mSQL = "SELECT MAX(Codes.DESCRIPTION) AS Description, SUBSTRING(Gledg.CODE,1," & CodeLen & ") AS Code, " & _
             ...
             "From Gledg, Codes, " & _
                   ...
                   "VDATE < '" & Format(Constants.ProjConst.SDate, "dd-MMM-yyyy") & "' " & _
                   "AND GLEDG.BRCODE = '" & SysBrCode & "' " & _
                   "AND GLEDG.POSTED = 'Y' " & _
                   "AND SUBSTRING(Gledg.CODE,1," & CodeLen & " ) = G.SUBCODE " & _
                   "AND Codes.CODE = G.SUBCODE+'" & Fillit("", "0", aCodeL - CodeLen) & "'" & _
        ...
        If PrtNotes Then
            ...
            mSQL = "SELECT MAX(Codes.DESCRIPTION) AS Description, SUBSTRING(Gledg.CODE,1," & CodeLen & ") AS Code, " & _
             ...
             "From Gledg, Codes, " & _
                   "(SELECT DISTINCT SUBSTRING(CODE,1," & CodeLen & ") SUBCODE FROM Gledg " & _
                   " WHERE SUBSTRING(CODE,1," & CodeLen & ")='" & TCode & "') G " & _
                   "WHERE VDATE Between '" & Format(Constants.ProjConst.SDate, "dd-MMM-yyyy") & "' And " & _
                   "'" & Format(TmpStr, "dd-MMM-yyyy") & "' " & _
                   "AND GLEDG.BRCODE = '" & SysBrCode & "' " & _
                   "AND GLEDG.POSTED = 'Y' " & _
                   "AND SUBSTRING(Gledg.CODE,1," & CodeLen & " ) = G.SUBCODE " & _
        ...
        If PrtNotes Then
            ...
            mSQL = "SELECT MAX(Codes.DESCRIPTION) AS Description, SUBSTRING(Gledg.CODE,1," & CodeLen & ") AS Code, " & _
             ...
             "From Gledg, Codes, " & _
                   "(SELECT DISTINCT SUBSTRING(CODE,1," & CodeLen & ") SUBCODE FROM Gledg " & _
                   " WHERE SUBSTRING(CODE,1," & CodeLen & ")='" & TCode & "') G " & _
                   "WHERE VDATE < '" & Format(Constants.ProjConst.SDate, "dd-MMM-yyyy") & "' " & _
                   "AND GLEDG.BRCODE = '" & SysBrCode & "' " & _
                   "AND GLEDG.POSTED = 'Y' " & _
                   "AND SUBSTRING(Gledg.CODE,1," & CodeLen & " ) = G.SUBCODE " & _
                   "AND Codes.CODE = G.SUBCODE+'" & Fillit("", "0", aCodeL - CodeLen) & "'" & _
