...
Public Class frmLogin
    ...
    Private Sub frmLogin_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'txtServer.Text = "CERP"
        txtServer.Text = "Zulfiqar-pc\sqlinstance"
    ...
    Private Sub btnConnect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConnect.Click
        ...
        Constants.ProjConst.SysServer = Trim(txtServer.Text)
        ...
        Finally
            ...
            End If
            objUsers.UserName = Constants.ProjConst.SysUser
                ...
                If Not objConnection Is Nothing Then
                    ...
                    If rowNum >= 0 Then
                        ...
                        Else
                            SpUser = False
                        End If
                        Constants.ProjConst.SysUserID = dtLogin.Rows(rowNum).Item("UserID").ToString
                        If Len(Constants.ProjConst.SysUserID) = 1 Then
                            Constants.ProjConst.SysUserID = "000" & Constants.ProjConst.SysUserID
                        ElseIf Len(Constants.ProjConst.SysUserID) = 2 Then
                            Constants.ProjConst.SysUserID = "00" & Constants.ProjConst.SysUserID
                        ElseIf Len(Constants.ProjConst.SysUserID) = 3 Then
                            Constants.ProjConst.SysUserID = "0" & Constants.ProjConst.SysUserID
                        End If
                        Call CreateDSN(Constants.ProjConst.SysDataBase, Constants.ProjConst.SysDsn, "DSN Accounts", "SQL Server", "C:\Winnt\System32\sqlsrv32.dll", Constants.ProjConst.SysUser, Constants.ProjConst.SysServer, "")
                        ''Report Connection String
                        RepConn = "DSN = " & Constants.ProjConst.SysDsn & ";UID = " & Constants.ProjConst.SysUser & ";PWD =" & Constants.ProjConst.SysPassword & ";DSQ = " & Constants.ProjConst.SysDataBase & ""
                        FlagUser = True
                        'picLogin.Image.Dispose()
                        'picLogin.Image = System.Drawing.Image.FromFile(Environment.CurrentDirectory & "\PNG-Logout_png-256x256.png")
                        ...
                        Logged = True
                        Call InitMenu()
                        If Constants.ProjConst.SysUser = Constants.ProjConst.BuiltInUser Then
                            Call formEnabled()
                            Call MenuSet(mdiMain, True)
                        Else

                            mSQL = "SELECT UserID FROM USERS WHERE UserName = '" & _
                                Trim(Constants.ProjConst.SysUser) & "'"
    ...
    Sub Add1stUser()
        ...
        objLogin.UserName = Constants.ProjConst.BuiltInUser
        objLogin.SpUser = True
        objLogin.AddOn = Constants.ProjConst.SySDate
        objLogin.AddBy = "0001"
    End Sub
    ...
    Public Sub Security()
        ...
        objUsers.UserID = Constants.ProjConst.SysUserID
