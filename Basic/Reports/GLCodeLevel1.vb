...
Public Class GLCodeLevel1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic.Reports.GLCodeLevel1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGLCodeLevel1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GLCodeLevel1 = New GLCodeLevel1()
        rpt.Site = Me.Site
        Return rpt
    End Function
