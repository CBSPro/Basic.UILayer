...
Public Class GLCodeLevel3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Basic.Reports.GLCodeLevel3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGLCodeLevel3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GLCodeLevel3 = New GLCodeLevel3()
        rpt.Site = Me.Site
        Return rpt
    End Function
